...
export const SnackbarProvider = ({ children }: { children: ReactNode }) => {
	...
	return (
		<SnackbarContext.Provider value={{ openSuccessSnackbar, openErrorSnackbar, openInfoSnackbar, closeSnackbar, forceCloseSnackbar }}>
			{children}
			{open && (type === "success" ? <SuccessSnackbar message={message} closeSnackbar={forceCloseSnackbar} fade={fade} /> : type === "error" ? <ErrorSnackbar message={message} closeSnackbar={forceCloseSnackbar} fade={fade} /> : <InfoSnackbar message={message} closeSnackbar={forceCloseSnackbar} fade={fade} />)}
